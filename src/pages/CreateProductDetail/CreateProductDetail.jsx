          ...
          <form action='#' method='POST'>
            <div className='shadow sm:overflow-hidden sm:rounded-md'>
              ...
              <div className='bg-gray-50 px-4 py-3 text-right sm:px-6'>
                <button
                  type='submit'
                  className='inline-flex justify-center rounded-md border border-transparent bg-main py-2 px-4 text-sm font-bold text-white shadow-sm hover:bg-second focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2'
