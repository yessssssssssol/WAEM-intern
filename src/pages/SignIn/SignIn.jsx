...
import liveCert from '../../assets/images/liveCert.png';
...
const SignIn = () => {
  ...
  const { loginEmail, loginPassword, loginLiveCERT } = loginInfo;
      ...
      <div className='bg-white lg:w-5/12 md:6/12 w-10/12 shadow-xl rounded-lg'>
        ...
        {isLogin ? (
          <form className='p-12 md:p-24'>
            ...
            <div className='flex items-center text-sm mt-6 md:mb-8'>
              <input
                type='text'
                id='liveCERT'
                name='loginLiveCERT'
                onChange={onHandleLogin}
                className='pl-12 py-2 md:py-4 rounded focus:outline-none focus:border-[#333333] focus:ring-[#333333] w-full'
                placeholder='LiveCERT Email'
              />
              <img
                className='absolute ml-3 w-[24px]'
                src={liveCert}
                alt='liveCert_login'
              />
            </div>
            <button
              onClick={onClickLiveCERT}
          ...
          <form className='p-12 md:p-24'>
            ...
            <div className='flex items-center text-lg mb-6 md:mb-8'>
              <svg
                className='absolute ml-3 text-main'
                viewBox='0 0 24 24'
                width='24'
              >
